...
* Meine persönliche Regel Nr. 1 des Teamaufbaus ist, dass die Mitgründer und -arbeiter die Besten in ihrem jeweiligen Handwerk sein müssen und (laut Amazon Leadership Principles) du nur Mitarbeiter einstellst, die besser sind als du selbst.
* Meine Regel Nr. 2 ist, dass ALLE Positionen besetzt sind.

Was gut funktionierte:
* Bestendes Netzwerk durch jahrelange Erfahrung bei u.a. Bigpoint und Mitgründer waren sehr gut in Ihrer jeweiligen Expertise.

Was nicht funktionierte:
* Wir waren alles Handwerker (Software-Entwickler, Game-Designer und Grafiker), jedoch fehlte uns notwenige wissenschaftliche und theoretische Erfahrung rund um BWL, Geschäftsführung, Projektmanagement und Marketing, was sich im Mangel an agiler Prozesserfahrung, fehlendem Verhandlungsgeschick und strategischer Weitsicht bemerkbar machte. Dies kostete uns Geld, Zeit und wir mussten unnötig aus dummen Fehlern lernen - die schon jeder Andere vor uns gemacht hatte.
...
* **Feedback-driven Development**: . Fehlendes und jahrelang unterschätztes Durchführen von A/B Testing, Online/Offline Surveys und kritischem Beobachten und Hinterfragen von User-Verhalten führe dazu, dass wir die Erwartungen des Users (der das Produkt benutzt) nie erreichen konnten (dafür konnten wir Publisher und Partner zufrieden stellen). Wie wichtig das ist, erfährt man anhand von KPIs und die Bestätigung erfolgt dann, wenn ein Produkt eingestellt wird (oder indirekt eingestellt wird, in dem es für tot erklärt ist). Selbst nach Einholen von Feedback hatten wir keine Zeit, dieses genau zu Untersuchen, Umzusetzen und Priorisierungen und Visionen komplett shiften zu können, wenn das Feedback darauf hinweist. Und man muss Zeit einplanen, diese neuen, auf Feedback-basierten Änderungen, zu beobachten und weiter drauf zu reagieren.
...
* **Das System**: Problem Problem liegt im System: Wenn ein Publisher 6 oder 12 Monate im Voraus jeden einzelnen Task geplant und eingeschätzt haben will, keine Erfahrungen in einer Distribution-Methode hat und sich weigert, eigene Game Design Expertise einzustellen oder zu viel dazwischen Reden muss, funktioniert eine **feedback-driven** und **agile** Entwicklung nicht. Der Prozess muss es von Anfang an hergeben, dass bei jedem Sprint Priorisierung neu in Frage gestellt werden dürfen und müssen und immer gefragt wird, was der User will.
* **Testmärkte**, Softlaunches, Statiken, Umfragen, Auf-die-Straße-gehen: Es gibt eine Vielzahl an Varianten, User-Empfinden herauszufinden und so moderne Produkte optimal an die gegenwärtigen Bedürfnisse zu optimieren: Ab dem ersten Prototypen kann so ein User-oriented workflow dabei helfen, das Produkt zu einem MVP (Minimum Viable Product) zu entwickeln, und jederzeit Feedback erhalten zu können. Dies kostet Zeit und Geld, erspart einem aber viele unnötigen Features und hilft dazu, den User zu erreichen.
